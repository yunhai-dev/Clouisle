...
ALLOWED_IMAGE_TYPES = {"image/jpeg", "image/png", "image/gif", "image/webp", "image/svg+xml", "image/x-icon"}
...
async def upload_image(
    ...
    ext = MIME_TO_EXT.get(content_type, os.path.splitext(file.filename or "")[1] or ".bin")
...
@router.delete("/files/{category}/{year}/{month}/{filename}", response_model=Response[None])
